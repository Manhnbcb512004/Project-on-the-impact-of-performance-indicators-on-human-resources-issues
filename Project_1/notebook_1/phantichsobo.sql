/* ============================================================================
   ...
   Dataset Source:
   This project utilizes datasets distributed under
   the Apache License 2.0.

   Original copyright belongs to the dataset creators.

   The dataset is used for educational, analytical,
   and portfolio purposes only.

   Apache License 2.0:
   http://www.apache.org/licenses/LICENSE-2.0

   SQL transformations, aggregations, KPI calculations,
   and analytical logic are independently developed
