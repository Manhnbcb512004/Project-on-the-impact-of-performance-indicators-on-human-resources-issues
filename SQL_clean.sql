...
This SQL script is part of the Credit Risk Analytics project and is released
under the MIT License. See LICENSE.md for full licensing information.
*/
...
-- 2. Xóa bảng nếu đã tồn tại để làm mới  
